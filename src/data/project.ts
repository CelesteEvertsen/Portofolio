...
export const item: Project[] = [{
  ...
  alt: 'Project preview',
  title: 'Weather App',
  description: 'A short teaser about what this project does.',
  content: 'Fun weather App projekt, that  fetches data from a weather API and displays it in a user-friendly way. It allows users to search for weather information by city name and provides details such as temperature, humidity, and weather conditions. The app is built using React and styled with CSS for a clean and responsive design. I am proud of this project because it demonstrates my ability to work with APIs and create a functional user interface.',
...
},
{
  ...
  alt: 'Project preview',
  title: 'Wizard of Web',
  description: 'A group project with focus on design and functionality.',
...
},
{
  ...
  alt: 'Project preview',
  title: 'Assembly',
  description: 'First introduction to React and useState',
